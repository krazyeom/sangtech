...
function processFile(filePath: string) {
    ...
    content = content.replace(/!p\.site_name\.includes\('맥스솔루션'\)\s*&&\s*!p\.site_name\.includes\('도전상품권'\)/g,
        "!p.site_name.includes('맥스솔루션') && !p.site_name.includes('기프너스') && !p.site_name.includes('VIP상품권') && !p.site_name.includes('더세일상품권')");
    ...
    // Fix some comments
    content = content.replace(/맥스솔루션, 도전상품권은 전체 랭킹 카운트에서 제외/g, '맥스솔루션, 기프너스, VIP상품권, 더세일상품권은 전체 랭킹 카운트에서 제외');
    content = content.replace(/\(exclude 맥스솔루션, 도전상품권 from best\)/g, '(exclude 맥스솔루션, 기프너스, VIP상품권, 더세일상품권 from best)');
