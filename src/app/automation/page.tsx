      ...
      {activeTab === 'ios' && (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
          ...
          <section className="card">
            ...
            <ol style={{ paddingLeft: '1.5rem', color: 'var(--text-secondary)', marginBottom: '1.5rem', lineHeight: '1.8' }}>
              <li>App Store에서 <a href="https://apps.apple.com/app/userscripts/id1463298887" target="_blank" rel="noreferrer" style={{ color: 'var(--accent-blue)', textDecoration: 'underline' }}><b>Userscripts</b> 앱을 다운로드</a> 및 설치합니다.</li>
